...
for_password.addEventListener("blur", (e) => {
  ...
  if (e.target.value == "" || e.target.value == null) {
    ...
    errBoard.innerHTML = "Enter valid password! your password should should contain captial letter,small letter,number.";
  } else {
    errBoard.innerHTML = "";
  }
});
...
for_password2.addEventListener("blur", (e) => {
  ...
  if (e.target.value == "" || e.target.value == null) {
    ...
    errBoard.innerHTML = "Both Passwords must be same";
  } else {
    errBoard = "";
  }
});
